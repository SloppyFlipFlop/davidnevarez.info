...
// This functional component represents a custom cursor with a custom-cursor effect.
function CustomCursor() {
  ...
  // Calculate the size of the custom-cursor based on whether the cursor is over a clickable element.
