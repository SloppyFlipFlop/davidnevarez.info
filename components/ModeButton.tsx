  ...
  return (
    <>
      <motion.button
        ...
        style={{
          justifyContent: currentTheme == "dark" ? "flex-start" : "flex-end",
        }}
        onClick={() => (theme == "dark" ? setTheme("light") : setTheme("dark"))}
        className="flex transition-all duration-700	ease-linear	 rounded-full bg-black dark:bg-white h-8 w-16"
      >
        <div className="rounded-full transition-all duration-700	ease-linear bg-white dark:bg-black h-8 w-8"></div>
      </motion.button>
